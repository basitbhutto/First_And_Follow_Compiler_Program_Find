...
namespace MyLL1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
          ...
          /*  basit.Rules.Add(basit.CreateTextRule("S->ABC"));
            basit.Rules.Add(basit.CreateTextRule("A->a/ε"));
            basit.Rules.Add(basit.CreateTextRule("B->b/ε"));
            basit.Rules.Add(basit.CreateTextRule("C->c/ε"));
...
*/
            ...
            /* basit.Rules.Add(basit.CreateTextRule("A->a/b/ε"));*/
